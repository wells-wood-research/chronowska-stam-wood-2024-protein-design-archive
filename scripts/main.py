...
def main(next_date, prev_date, all_option=False):
    ...
    wait_for_user("""Release dates of all PDBs:
                  ...
                  2. select \"Create Custom Report\" instead of \"Tabular Report\", select \"Release Date\" checkbox, then run report and download CSV file
                  3. download only the most recent file as save to /home/mchrnwsk/pda-destress-analysis/data/pdb_release_dates - last download up to 243'911
    ...
    # Step 12: extract_designed_chains_from_pdb.py
    ...
    # Step 19: Tidy up: remove manually excluded entries, recalculate previous and next designs, and manually curate data
    run_command(
    ...
    # Step 20: Move output to github and elm app directory

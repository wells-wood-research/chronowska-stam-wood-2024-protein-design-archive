...
def main(next_date, prev_date, all_option=False):
    ...
    wait_for_user(f"""Designed FASTA sequences:
                  ...
                  2. Download FASTA for all designed sequences and save to /home/mchrnwsk/pda-destress-analysis/data/{next_date}_designed_sequences.fasta
            See print above ^^^
                  """)
    ...
    wait_for_user(f"""Run MMseqs2 DvD and DvP commands manually on PC:

sudo bash /home/mchrnwsk/pda-destress-analysis/similarity/mmseq/{next_date}/DvD/search_dvd.sh

sudo bash /home/mchrnwsk/pda-destress-analysis/similarity/mmseq/{next_date}/DvP/search_dvp.sh
    """)

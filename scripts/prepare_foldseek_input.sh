...
for type in "${analysis_type[@]}"; do
    ...
    ssh mchrnwsk@cysteine.bio.ed.ac.uk "mkdir -p /home/mchrnwsk/pda/foldseek/$next_date/$type/analysis/"
    ssh mchrnwsk@cysteine.bio.ed.ac.uk "mkdir -p /home/mchrnwsk/pda/foldseek/$next_date/$type/data/"
    ssh mchrnwsk@cysteine.bio.ed.ac.uk "mkdir -p /home/mchrnwsk/pda/foldseek/$next_date/$type/output/"

    # Copy pdb_files_chains directory
    scp -r /home/mchrnwsk/pda-destress-analysis/data/pdb_files_chains \
        mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/"$next_date"/$type/

    # Copy data.json to analysis directory
    scp -r /home/mchrnwsk/pda-destress-analysis/data/"$next_date"_data.json \
        mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/"$next_date"/"$type"/analysis
...
scp -r /home/mchrnwsk/pda-destress-analysis/similarity_analysis_foldseek.py \
    mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/"$next_date"

scp -r /home/mchrnwsk/chronowska-stam-wood-2024-protein-design-archive/Foldseek/foldseek_search_dvd.sh \
    mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/"$next_date"/DvD
...
scp -r /home/mchrnwsk/chronowska-stam-wood-2024-protein-design-archive/Foldseek/foldseek_search_dvp.sh \
    mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/"$next_date"/DvP
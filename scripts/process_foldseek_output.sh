...
for type in "${analysis_type[@]}"; do
    ...
    scp -r mchrnwsk@glycine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/$next_date/"$type"_max_related_structure_lddt_95.json /home/mchrnwsk/pda-destress-analysis/similarity/foldseek/$next_date

    scp -r mchrnwsk@glycine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/$next_date/"$type"_thr_related_structure_lddt_95.json /home/mchrnwsk/pda-destress-analysis/similarity/foldseek/$next_date

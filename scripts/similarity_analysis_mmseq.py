...
current_dir_mmseq_analysis = base_dir_analysis+"/"+update_date+"/"+analysis_type
output_file = current_dir_mmseq+"/"+analysis_type+"_related_sequence_"+str(metric)+"_"+str(round(threshold))

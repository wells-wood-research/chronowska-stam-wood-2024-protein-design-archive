...
scp -r mchrnwsk@cysteine.bio.ed.ac.uk:/home/mchrnwsk/pda/foldseek/$next_date/"$next_date"_data_merizo.json /home/mchrnwsk/pda-destress-analysis/data/"$next_date"_data_merizo.json
...
for type in "${analysis_type[@]}"; do
    ...
    ssh mchrnwsk@cysteine.bio.ed.ac.uk "rm -r /home/mchrnwsk/pda/foldseek/$next_date/pdb_files"
    ssh mchrnwsk@cysteine.bio.ed.ac.uk "rm -r /home/mchrnwsk/pda/foldseek/$next_date/pdb_files_chains"
